...
On garde les variables Tree_bush_natural, Animal et Herba_notincroop car ils ont été consommés dans les deux types de sites (anthropisé et non anthropisé) et on garde toutes les activités
...
Si la variable mois nous est d'intérêt puisqu'on pourrait dicerner des variations de diets selon les mois
mais aussi selon les mois et les types de site (intéraction), les groupes n'apportent pas d'information biologique
...
On observe que les valeurs pour les loglik observé du modèle sans interaction et sans interaction + type_site sont extrémement proches 81.9 pour interaction et 87.2 pour type_site
...
En résumé la consommation de Natural tree bush à tendance à être moindre sur les sites anthropisé mais reste plus constante au cours des saisons par rapport au site anthropisé où leur consommation varie plus au cours des saisons
...
On peut conclure que les besoins alimentaires liés à la consomation d'animaux ne sont pas compensé par d'autres nouriture anthropisé. 
...
Pour les champignons il existe deux hypothèse : soit les besoins alimentaire sont entièrement remplacé par d'autres ressources anthropisées, mais aussi que les champignons consommées par les macaques ne sont pas présent sur les sites anthropisé.
...
Concernant le foraging, les mois ont un impact important sur cette activite. Avec plus de foraging dans les mois 6 et 11, associé à un foraging plutôt dans les parcelles agricoles. Cependant le type de site seul, ne semble pas avoir un impact important sur le foraging, seul l'interaction avec certains mois semble modifier les comportements des macaques. 
...
Concernant le Feeding, les types de sites, ainsi que les mois, et leur interaction semble avoir un impact sur cette activité. Avec une augmentation dans les mois 7,8 et 10 du Feeding dans les sites non agricoles. 
...
L'activite de moving, ne semble pas impacter par le type de site, ou par des mois en particulier. Cependant la variable mois de manière globale semble impacté le déplacement. Avec des deplacements probablement (mais pas significativement) different pour les mois 6 et 11. 
...
Concernant l'activité de Resting, celle-ci semble impacté par les mois ainsi que par les types de sites. Avec une probable augmentation du resting lorsque les mois de l'année avance (lorsque on est plutôt en fin d'année, par rapport à juin).
...
Concernant l'activité Social, celle-ci ne semble pas impacter par le type de site, ou par des mois en particulier. Cependant la variable mois de manière globale semble impacté l'activité social. Avec une baisse probable (mais pas significativement) de cette activité au cours de l'année. 
...
Un dharma a été réalisé pour la validation des modèles. Cependant 4 de nos modèles sur 8, ne semblent pas être validés. Les trois modèles de nourriture ainsi que le modèle de Foraging. Les résultats pour ces modèles sont donc à considérer dans ce sens. La possible cause est que ces variables comportentbeaucoup d'observations nulles, ce qui est probablement la cause de ce problème. Il faudrait essayer de trouver des solutions d'améliorations pour ces modèles (transformation des données, modification de la loi...)
